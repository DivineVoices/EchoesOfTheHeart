...
define intello = "Hotaru"
define tsundere = "Airi"
define chuunibyou = "Yukiko"
define sportive = "Kagayai"
define populaire = "Yuzu"
define anon = "Numéro Inconnu"
            ...
            hbox:
                ...
                if previous_d_who != d.who:
                    if d.who == MC_Name:
                        ...
                        $ message_icon = "icon/kagayai_icon.png"
                    elif d.who == populaire:
                        $ message_icon = "icon/yuzu_icon.png"
                    elif d.who == chuunibyou:
                        $ message_icon = "icon/yukiko_icon.png"
                    elif d.who == tsundere:
                        $ message_icon = "icon/airi_icon.png"
                    elif d.who == intello:
                        $ message_icon = "icon/hotaru_icon.png"
                    elif d.who == anon:
                        $ message_icon = "icon/anon_icon.png"
                    else:
